...
/**
 * Class Experience_technologie
 *
 * @package App
 * @author Jerome Dh <jdieuhou@gmail.com>
 * @date 05/10/2020 21:37
 */
class Experience_technologie extends Model
{
    /**
    ...
    /**
     * Get the technologie relational
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function technologie() {
        return $this->belongsTo('App\Models\Technologie', 'technologie_id', 'id');
    }
